...
if __name__ == '__main__':
    npy_path = r'/data/zhangxinyan/dataset/Carrada/2019-09-16-12-52-12/range_angle_numpy'
    mat_path = r'/data/zhangxinyan/dataset/Carrada/2019-09-16-12-52-12/range_angle_mat'
    npy2mat(npy_path, mat_path)